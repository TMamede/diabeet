...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function register(): void
    {
        $validated = $this->validate([
            'name' => ['required', 'string', 'max:255', 'no_badwords'],
...
<div>
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="coren" id="coren" class="block w-full mt-1" type="text" name="coren" required autofocus autocomplete="coren" />
            <x-input-error :messages="$errors->get('coren')" class="mt-2" />
        </div>
