                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="p-8 md:p-12 lg:p-16">
                        ...
                        @if (session()->has('success'))
                            <div class="relative px-6 py-4 mb-8 text-green-800 border-l-4 border-green-400 rounded-lg bg-gradient-to-r from-green-50 to-green-100"
                                role="alert">
                    ...
                    <div
                        ...
                        <div
                            class="relative z-10 flex flex-col justify-center items-center p-8 md:p-12 lg:p-16 min-h-[600px]">
                            ...
                            <div class="mb-8 text-center">
                                ...
                                <p class="max-w-sm text-lg leading-relaxed text-indigo-100">
                                    Nossa equipe está pronta para esclarecer suas dúvidas sobre o sistema.
                                </p>
                            </div>
                            ...
                            <div class="w-full max-w-sm space-y-6">
                                <!-- Contato Telefone -->
                                <div
                                    class="flex items-center p-4 space-x-4 bg-white bg-opacity-10 backdrop-blur-sm rounded-xl hover:bg-opacity-20">
                                    <div
                                        class="flex items-center justify-center w-12 h-12 bg-white rounded-full bg-opacity-20">
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-indigo-200">sipedia@unimontes.br</p>
                                    </div>
                                </div>
