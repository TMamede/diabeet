                ...
                <main class="flex-1 p-6 pb-10 bg-stone-50">
                    ...
                    <div class="mt-4">
                        <div class="grid grid-cols-1 gap-2 md:grid-cols-2">
                            <div>
                                <h3 class="text-lg font-semibold text-indigo-800">Nome da Unidade:</h3>
                                <p class="text-base text-gray-900">{{ $unidade->nome }}</p>
                            </div>
                            <div>
                                <h3 class="text-lg font-semibold text-indigo-800">Rua:</h3>
                                <p class="text-base text-gray-900">{{ $unidade->endereco->rua }}</p>
                            </div>
                            <div>
                                <h3 class="text-lg font-semibold text-indigo-800">Bairro:</h3>
                                <p class="text-base text-gray-900">{{ $unidade->endereco->bairro }}</p>
                            </div>
                            <div>
                                <h3 class="text-lg font-semibold text-indigo-800">Cidade:</h3>
                                <p class="text-base text-gray-900">{{ $unidade->endereco->cidade }}</p>
                            </div>
                            <div>
                                <h3 class="text-lg font-semibold text-indigo-800">Unidade Federativa:</h3>
                                <p class="text-base text-gray-900">{{ $unidade->endereco->uf }}</p>
                            </div>
                        </div>
                    </div>
                    @else
