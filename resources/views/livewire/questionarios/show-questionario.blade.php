        ...
        @if ($currentStep == 1)
            <div class="step">
                <div class="flex">
                    ...
                    <!-- Conteúdo da Página -->
                    <main class="flex-1 p-6 pb-10 bg-stone-50">



                        <h2 class="py-5 text-3xl font-bold">Dados do Paciente Associado</h2>
                    ...
                    <main class="flex-1 p-6 pb-10 bg-stone-50">
                            ...
                            <div class="flex mb-4 space-x-4">
                                ...
                                <div class="w-1/3">
                                    ...
                                    <select wire:model="comportamento_regulacao_neuro_id"
                                        id="comportamento_regulacao_neuro_id" disabled
                                            ...
                                            @foreach ($problemaSonoList as $problema)
                                                <div class="flex items-center">
                                                    <input type="checkbox" wire:model="problema_sonos"
                                                        value="{{ $problema->id }}"
                                                        id="problema-{{ $problema->id }}" disabled
                                                        class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                            ...
                            <div class="flex items-center mb-4 space-x-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model.defer="peso" id="peso"
                                        placeholder="Digite o peso em kg" disabled
                                        class="block w-full mt-1 border border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                </div>
                        ...
                        <div class="flex items-center mb-4 space-x-4">
                            <div class="w-1/3">
                                ...
                                <input type="number" wire:model="circunferencia_abdnominal"
                                    id="circunferencia_abdnominal" disabled
                                    class="block w-full mt-1 border border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" wire:model="temp_enchimento_capilar"
                                    id="temp_enchimento_capilar" disabled
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" wire:model="frequencia_respiratoria"
                                    id="frequencia_respiratoria" disabled
                                    class="block w-2/5 mt-1 border border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div>
                                    <div class="mb-8">
                                        <label class="block mb-2 font-medium text-gray-700">Sinais de
                                            Infeccção</label>
                                        <div class="grid grid-cols-2 gap-4">
                                            @foreach ($sinaisInfeccaoList as $sinais)
                                                <div class="flex items-center">
                                                    <input type="checkbox" wire:model="sinais_infeccaos"
                                                        value="{{ $sinais->id }}"
                                                        id="sinais-{{ $sinais->id }}" disabled
                                                        class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                                    <label for="sinais-{{ $sinais->id }}"
                                                        class="ml-2 text-gray-700">
                                                        {{ $sinais->descricao }}
                                                    </label>
                                                </div>
                                    ...
                                    <div class="flex items-center mb-4 space-x-10">
                                        <div>
                                            <label for="comprimentoD"
                                                class="block font-medium text-gray-700">Comprimento
                                                (cm):</label>
                                            <input type="number" wire:model="comprimentoD" id="comprimentoD"
                                                disabled placeholder="Digite o comprimento"
                                                class="block w-full mt-1 border border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        <label for="lesao_amputacaoD"
                                            class="block mb-2 font-medium text-gray-700">Lesão
                                ...
                                <div class="flex mt-6 mb-4 space-x-4">
                                    <!-- Zona de Moradia -->
                                    <div class="w-1/4">
                                        <label for="bordas_ferida_id" class="block font-medium text-gray-700">Bordas
                                            da
                                            Ferida</label>
                                    ...
                                    <!-- Rede de Esgoto -->
                                    <div class="w-1/4">
                                        <label for="tipo_tecido_ferida_id"
                                            class="block font-medium text-gray-700">Tipo de
                                ...
                                <div class="flex mb-4 space-x-4">
                                    ...
                                    <!-- Rede de Esgoto -->
                                    <div class="w-1/4">
                                        <label for="aspecto_exudato_id"
                                            class="block font-medium text-gray-700">Aspecto do
                                            Exudato</label>
                                ...
                                <div class="flex mb-4 space-x-4">
                                    <!-- Primeiro div: Sapato adequado -->
                                    <div class="w-1/4">
                                        <label for="odor_exudato" class="block mb-2 font-medium text-gray-700">Odor
                                            do
                                            exudato:</label>
                                        <div class="flex items-center mt-1 space-x-6">
                                            <label class="inline-flex items-center">
                                ...
                                <div class="w-full">
                                    <label for="dor"
                                        class="block mb-4 text-lg font-medium text-gray-700">Intensidade da
                                        Dor:</label>
                            ...
                            <div>
                                            ...
                                            @foreach ($limpezaLesaosList as $limpeza)
                                                <div class="flex items-center">
                                                    <input type="checkbox" wire:model="limpeza_lesaos"
                                                        value="{{ $limpeza->id }}"
                                                        id="limpeza-{{ $limpeza->id }}" disabled
                                                        class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                    ...
                                    <div class="w-1/3">
                                        <div class="w-full">
                                            <label for="desbridamento_id"
                                                class="block font-medium text-gray-700">Tipos de
                                                Desbridamento:</label>
                                ...
                                <div>
                                    <label for="imagem_avaliacao_pe"
                                        class="block mt-4 text-lg font-medium text-gray-700">Avaliação do Pé
                                        (Imagem)</label>
                                    <div
                                        ...
                                        <input type="file" id="imagem_avaliacao_pe" disabled
                ...
                <div class="flex">
                    ...
                    <main class="flex-1 p-6 pb-10 bg-stone-50">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" wire:model="monitoramento_glicemia_dia"
                                    id="monitoramento_glicemia_dia" disabled
                                ...
                                <div class="w-3/5">
                                    <div class="mb-4">
                                        <label for="regime_terapeutico"
                                            class="block mb-2 font-medium text-left text-gray-700">Compreende e
                                            executa o
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                <label for="opnioes_de_si" class="block mb-2 font-medium text-gray-700">Opiniões de
                                    si
                            ...
                            <div class="mb-4">
                                <label for="auxiliador" class="block font-medium text-gray-700">Quem mais auxilia no
                                    seu
                                    tratamento:</label>
                        ...
                        <div class="mb-10">
                            ...
                            <div class="flex mb-4 space-x-4">
                                ...
                                <!-- Segundo div -->
                                <div class="w-1/3">
                                    <label for="interacao_social"
                                        class="block mb-2 font-medium text-gray-700">Interação
                ...
                <div class="flex">
                    ...
                    <main class="flex-1 p-6 pb-10 bg-stone-50">
                        ...
                        @if ($e_religioso = 'sim')
                            <div class="mb-6">
                                <label for="religiao"
                                    class="block mb-4 text-3xl font-bold text-gray-700 ">Religião/Espiritualidade:</label>
