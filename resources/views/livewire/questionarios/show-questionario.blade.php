        ...
        <div class="step">
            <div class="flex">
                ...
                <main class="flex-1 p-6 bg-stone-50">
                    ...
                    <h2 class="py-5 text-lg font-bold">Necessidades Biológicas</h2>
        ...
        <div class="step">
            <div class="flex">
                ...
                <main class="flex-1 p-6 bg-stone-50">
                    ...
                    <h2 class="py-5 text-lg font-bold">Necessidades Sociais</h2>
        ...
        <div class="step">
            <div class="flex">
                ...
                <main class="flex-1 p-6 bg-stone-50">
                    ...
                    <h2 class="py-5 text-lg font-bold">Informações Finais</h2>
