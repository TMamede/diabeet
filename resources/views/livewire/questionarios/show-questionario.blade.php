                                        ...
                                        <div class="p-8 border shadow-lg bg-white/80 rounded-3xl border-white/20">
                                            <div class="flex items-center mb-8">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-gray-600">Informações clínicas e histórico de saúde
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                                                ...
                                                <div class="p-6 border border-red-100 bg-red-50 rounded-xl">
                                                    <h4
                                                        class="flex items-center mb-4 text-lg font-semibold text-red-800">
                                                    ...
                                                    <div class="space-y-3">
                                                        ...
                                                        @empty
                                                            <p class="italic text-gray-500">Nenhuma comorbidade
                                                                registrada
                                                            </p>
                                                        @endforelse
                                                    </div>
                                                ...
                                                <div class="p-6 border border-orange-100 bg-orange-50 rounded-xl">
                                                    ...
                                                    <div class="space-y-3">
                                                        @forelse ($selectedPaciente->historico->alergias as $alergia)
                                                            <div
                                                                class="p-3 bg-white border border-orange-200 rounded-lg">
                                                                <span
                                                                    class="font-medium text-gray-800">{{ $alergia->descricao }}</span>
                                                            </div>
                                                        @empty
                                                            <p class="italic text-gray-500">Nenhuma alergia registrada
                                                            </p>
                                                        @endforelse
                                                    </div>
                                                </div>
                                    ...
                                    <div class="max-w-6xl px-6 mx-auto mb-8">
                                        <div class="p-8 border shadow-lg bg-white/80 rounded-3xl border-white/20">
                                            <div class="flex items-center mb-8">
                                                ...
                                                <div>
                                                    <h3 class="text-2xl font-bold text-gray-800">Medicamentos em Uso
                                                    </h3>
                                            ...
                                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                                    ...
                                                    <div class="p-6 border border-green-100 bg-green-50 rounded-xl">
                                                        ...
                                                        <div class="space-y-2">
                                                            <div class="flex justify-between">
                                                                <span
                                                                    class="text-sm font-medium text-gray-600">Via:</span>
                                                                <span
                                                ...
                                                @empty
                                                    <div class="py-8 text-center col-span-full">
                                                        <p class="italic text-gray-500">Nenhum medicamento registrado
                                                        </p>
                                                    </div>
                                                @endforelse
                                            </div>
                                    ...
                                    <div class="max-w-6xl px-6 mx-auto mb-8">
                                        <div class="p-8 border shadow-lg bg-white/80 rounded-3xl border-white/20">
                                            <div class="flex items-center mb-8">
                                                ...
                                                <div>
                                                    <h3 class="text-2xl font-bold text-gray-800">Resultados de Exames
                                                    </h3>
            ...
            <div class="step">
                    ...
                    <div class="flex-1 min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
                        ...
                        <div class="relative z-10 px-4 py-8 sm:px-6 lg:px-8">
                            ...
                            <div class="max-w-6xl mx-auto mb-8 hidden lg:block">
                                <div class="p-4 border shadow-lg sm:p-6 bg-white/90 rounded-3xl border-white/20">
                                    <div
                                        ...
                                        <div>
                                            <h1 class="text-2xl font-bold sm:text-3xl text-indigo-900">SoPeP</h1>
                                            <p class="text-sm font-medium sm:text-base text-indigo-600">Sistema de
                                                Prescrição Eletrônica para Pé Diabético</p>
                                        </div>
                            ...
                            <div class="max-w-6xl mx-auto">
                                <fieldset disabled>
                                    <div
                                        class="p-4 border shadow-lg sm:p-6 lg:p-8 bg-white/90 rounded-3xl border-white/20">
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="orientado"
                                                                value="1"
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div
                                                class="grid grid-cols-1 gap-6 mb-6 sm:gap-8 sm:mb-8 sm:grid-cols-2 lg:grid-cols-3">
                                                <!-- Olho direito -->
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    <label
                                                        class="block mb-4 text-base font-semibold sm:text-lg text-gray-800">
                                            ...
                                            <div class="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <select wire:model="analise_tato_id" id="analise_tato_id"
                                                        ...
                                                        @foreach ($analiseTatos as $tato)
                                                            <option value="{{ $tato->id }}">
                                                                {{ $tato->descricao }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="risco_queda"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                ...
                                                <select wire:model="alimento_consumo_id" id="alimento_consumo_id"
                                                    class="w-full px-4 py-3 text-sm text-gray-700 bg-white border-2 border-gray-200 sm:text-base md:w-1/2 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none">
                                                    <option value="">Selecione</option>
                                                    @foreach ($alimentoConsumos as $alimento)
                                                        <option value="{{ $alimento->id }}">
                                                            {{ $alimento->descricao }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                ...
                                                <input type="text" wire:model="medicamentos_sono"
                                                    ...
                                                    class="w-full px-4 py-3 text-sm text-gray-700 bg-white border-2 border-gray-200 sm:text-base md:w-2/3 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none"
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div class="grid grid-cols-1 gap-6 sm:gap-8 sm:grid-cols-2">
                                                <!-- Luz Pública -->
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    <label
                                                        class="block mb-4 text-base font-semibold sm:text-lg text-gray-800">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="luz_publica"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="coleta_lixo"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="grid grid-cols-1 gap-4 mb-4 sm:gap-6 sm:mb-6 sm:grid-cols-2 md:grid-cols-3">
                                                    <!-- Altura -->
                                                    <div>
                                                        <label for="altura"
                                                    ...
                                                    <div class="flex items-end">
                                                        <button type="button" wire:click="calcularIMC"
                                                            class="w-full px-4 py-2 text-base font-semibold text-white shadow-lg sm:px-6 sm:py-3 sm:text-lg bg-gradient-to-r from-indigo-500 to-indigo-700 rounded-xl hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-indigo-300">
                                                            Calcular IMC
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                @if ($imc)
                                                    <div
                                                        class="p-3 border border-indigo-200 sm:p-4 bg-indigo-50 rounded-xl">
                                                        <div
                                                ...
                                                <div class="mb-4 sm:mb-6">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-4">
                                                        <button type="button" wire:click="$set('estado_glicemia', 1)"
                                                            class="px-4 py-2 text-base font-semibold sm:px-6 sm:py-3 sm:text-lg rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-200 {{ $estado_glicemia === 1 ? 'bg-indigo-600 text-white shadow-lg' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
                                                            Em Jejum
                                                        </button>
                                                        <button type="button" wire:click="$set('estado_glicemia', 0)"
                                                            class="px-4 py-2 text-base font-semibold sm:px-6 sm:py-3 sm:text-lg rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-200 {{ $estado_glicemia === 0 ? 'bg-indigo-600 text-white shadow-lg' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div class="grid grid-cols-1 gap-6 mb-6 sm:gap-8 sm:mb-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="dor_urinar"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                            ...
                                            <div class="grid grid-cols-1 gap-6 mb-6 sm:gap-8 sm:mb-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio"
                                                                wire:model="incontinencia_eliminacao" value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio"
                                                                wire:model="incontinencia_eliminacao" value="0"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Não</span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="grid grid-cols-1 gap-6 mb-6 sm:gap-8 sm:mb-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="constipacao"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="diarreia"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                            ...
                                            <div class="grid grid-cols-1 gap-6 mb-6 sm:gap-8 sm:mb-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="uso_laxante"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                                ...
                                                <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex flex-col gap-3 sm:flex-row sm:gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="uso_fraldas"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div class="p-4 border border-gray-100 sm:p-6 bg-gray-50 rounded-2xl">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="grid grid-cols-1 gap-4 mb-4 sm:gap-6 sm:mb-6 sm:grid-cols-2 lg:grid-cols-4">
                                                        <!-- PSATP Direito -->
                                                        <div>
                                                        ...
                                                        <div class="flex items-end">
                                                            <button type="button" wire:click="calcularITBDireito"
                                                                class="w-full px-3 py-2 text-sm font-medium text-white rounded-lg shadow-lg sm:px-4 bg-gradient-to-r from-indigo-500 to-indigo-700 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-indigo-300">
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            <div class="mb-8">
                                                <h2 class="mb-2 text-2xl font-bold text-indigo-900">Sensopercepção
                                                </h2>
                                                <div
                                                    class="w-24 h-1 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-700">
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <label
                                                    class="block mb-4 text-base font-semibold text-gray-800 md:text-lg">
                                                    Sintomas:
                                                </label>
                                                    ...
                                                    @foreach ($sintomasPercepcaoList as $sintomas)
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="checkbox" wire:model="sintomas_percepcaos"
                                                                ...
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 rounded focus:ring-indigo-500">
                                                            <span
                                                                class="ml-3 text-sm font-medium text-gray-700 md:text-base">{{ $sintomas->descricao }}</span>
                                                        </label>
                                                    @endforeach
                                                </div>
                                            ...
                                            <div
                                                class="p-4 mb-8 border border-gray-100 md:p-6 bg-gray-50 rounded-2xl">
                                                <div class="mb-4">
                                                    <h3 class="text-base font-semibold text-gray-800 md:text-lg">
                                                        Referência Visual</h3>
                                                </div>
                                                <div class="flex justify-center">
                                                    <div class="relative w-full h-40 max-w-md md:h-48">
                                            ...
                                            <div
                                                ...
                                                <div class="mb-6">
                                                    <h3 class="text-base font-semibold text-gray-800 md:text-lg">
                                                        Cuidados e Condições dos Pés</h3>
                                                </div>
                                            ...
                                            <div class="p-4 border border-gray-100 md:p-6 bg-gray-50 rounded-2xl">
                                                ...
                                                <div x-data="{ selectedOption: @entangle('selectedOption') }">
                                                    ...
                                                    <div class="mb-8">
                                                        <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
                                                            ...
                                                            <button type="button" @click="selectedOption = 1"
                                                                ...
                                                                class="p-3 text-sm text-white transition-all duration-200 md:p-4 md:text-base rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-300">
                                                                <div class="font-semibold">Percepção da</div>
                                                                <div class="font-semibold">Sensibilidade Protetora
                                                                </div>
                                                            </button>
                                                            ...
                                                            <button type="button" @click="selectedOption = 2"
                                                                ...
                                                                :class="selectedOption === 2 ?
                                                                    ...
                                                                    'bg-indigo-600 hover:bg-indigo-700'"
                                                                class="p-3 text-sm text-white transition-all duration-200 md:p-4 md:text-base rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-300">
                                                                <div class="font-semibold">Sensibilidade</div>
                                                                <div class="font-semibold">Vibratória</div>
                                                            </button>
                                                            ...
                                                            <button type="button" @click="selectedOption = 3"
                                                                ...
                                                                :class="selectedOption === 3 ?
                                                                    ...
                                                                    'bg-indigo-600 hover:bg-indigo-700'"
                                                                class="p-3 text-sm text-white transition-all duration-200 md:p-4 md:text-base rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-300">
                                                                <div class="font-semibold">Ipswich</div>
                                                                <div class="font-semibold">Touch Test</div>
                                                            </button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div x-show="selectedOption" x-transition class="space-y-6">
                                                        <!-- Pé Direito -->
                                                        <div
                                                            class="p-4 bg-white border border-gray-200 md:p-6 rounded-xl">
                                                            <h4
                                                                class="mb-4 text-base font-semibold text-gray-800 md:text-lg">
                                                                Pé Direito</h4>
                                                            <div class="space-y-3">
                                                                <label class="flex items-start cursor-pointer">
                                                                    <input type="radio"
                                                                        wire:model="percepcao_direito"
                                                                        value="1"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            presente</span>
                                                                        (responder corretamente em duas das três
                                                                        aplicações)
                                                                    </span>
                                                                </label>
                                                                <label class="flex items-start cursor-pointer">
                                                                    ...
                                                                    <span
                                                                        class="ml-3 text-sm font-medium text-gray-700 md:text-base">
                                                                        <span
                                                                            class="font-semibold text-red-700">Percepção
                                                                            ausente</span>
                                                                        (falhar em responder corretamente em duas das
                                                                        três aplicações)
                                                                    </span>
                                                                </label>
                                                            </div>
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            <div class="mb-8">
                                                <h2 class="mb-2 text-2xl font-bold text-indigo-900">Integridade
                                                    Cutânea</h2>
                                                <div
                                                    class="w-24 h-1 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-700">
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex flex-col gap-3 sm:flex-row">
                                                    <button type="button"
                                                        ...
                                                        class="flex-1 px-4 py-3 text-sm font-semibold transition-all duration-200 md:px-6 md:text-base rounded-xl shadow-md
                ...
                {{ $ladoSelecionado === 'esquerdo'
                    ...
                    : 'bg-white border-2 border-indigo-300 text-indigo-700 hover:bg-indigo-50' }}">
                                                    ...
                                                    <button type="button"
                                                        wire:click="$set('ladoSelecionado', 'ambos')"
                                                        class="flex-1 px-4 py-3 text-sm font-semibold transition-all duration-200 md:px-6 md:text-base rounded-xl shadow-md
                {{ $ladoSelecionado === 'ambos'
                    ...
                    : 'bg-white border-2 border-indigo-300 text-indigo-700 hover:bg-indigo-50' }}">
                                            ...
                                            <div wire:key="lado-{{ $ladoSelecionado }}">
                                                ...
                                                @if ($ladoSelecionado === 'direito' || $ladoSelecionado === 'ambos')
                                                            ...
                                                            @foreach ($sinaisInfeccaoList as $sinais)
                                                                <label class="flex items-center cursor-pointer">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        class="w-5 h-5 text-indigo-600 border-2 border-gray-300 rounded focus:ring-indigo-500">
                                                                    <span
                                                                        class="ml-3 text-sm font-medium text-gray-700 md:text-base">{{ $sinais->descricao }}</span>
                                                                </label>
                                                            @endforeach
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2">
                                                            <div>
                                                                <label
                                                                    class="block mb-2 text-base font-semibold text-gray-800 md:text-lg">Comprimento
                                                                    (cm):</label>
                                                                <input type="number"
                                                            ...
                                                            <div>
                                                                <label
                                                                    class="block mb-2 text-base font-semibold text-gray-800 md:text-lg">Largura
                                                                    (cm):</label>
                                                                <input type="number"
                                                                    wire:model="dados.direito.largura"
                                                                    step="0.1"
                                                                    class="w-full px-4 py-3 text-sm text-gray-700 bg-white border-2 border-gray-200 md:text-base rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none"
                                                                    placeholder="Ex: 1.8">
                                                        ...
                                                        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2">
                                                            <div>
                                                                ...
                                                                <select
                                                                    wire:model="dados.direito.localizacao_lesao_id"
                                                            ...
                                                            <div class="flex gap-6">
                                                                <label class="flex items-center cursor-pointer">
                                                                    <input type="radio"
                                                                        ...
                                                                        class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                                    <span
                                                                        class="ml-3 text-sm font-medium text-gray-700 md:text-base">Sim</span>
                                                                </label>
                                                                <label class="flex items-center cursor-pointer">
                                                                    <input type="radio"
                                                                        wire:model="dados.direito.lesao_amputacao"
                                                                        ...
                                                                        class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                                    <span
                                                                        class="ml-3 text-sm font-medium text-gray-700 md:text-base">Não</span>
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2">
                                                            <div>
                                                                ...
                                                                <select
                                                                    wire:model="dados.direito.quantidade_exudato_id"
                                                        ...
                                                        <div class="mb-8">
                                                            ...
                                                            <!-- Para Mobile: Grid de 6 colunas em 2 linhas -->
                                                            <div
                                                                class="grid grid-cols-6 gap-2 p-4 bg-white border border-gray-200 md:hidden rounded-xl">
                                                                @for ($i = 0; $i <= 10; $i++)
                                                                    @php
                                                                        $color = match (true) {
                                                                            $i <= 3
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        class="flex flex-col items-center p-2 transition-all duration-200 cursor-pointer rounded-xl hover:shadow-md {{ $color }} {{ $selected }}">
                                                                        <span
                                                                            class="mb-1 text-lg">{{ $emoji }}</span>
                                                                        <span
                                                                            class="text-xs font-bold">{{ $i }}</span>
                                                                    </button>
                                                                @endfor
                                                            </div>
                                                            <!-- Para Desktop: Grid de 11 colunas -->
                                                            <div
                                                                class="hidden grid-cols-11 gap-2 p-4 bg-white border border-gray-200 md:grid rounded-xl">
                                                                @for ($i = 0; $i <= 10; $i++)
                                                                    @php
                                                                        $color = match (true) {
                                                                            $i <= 3
                                                ...
                                                {{-- Lesão em Pé Esquerdo - Mesmo padrão aplicado --}}
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2">
                                                            ...
                                                            <div>
                                                                <label
                                                                    ...
                                                                    (cm):</label>
                                                                <input type="number"
                                                                    wire:model="dados.esquerdo.largura"
                                                                    step="0.1"
                                                                    class="w-full px-4 py-3 text-sm text-gray-700 bg-white border-2 border-gray-200 md:text-base rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none"
                                                                    placeholder="Ex: 1.8">
                                                        ...
                                                        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2">
                                                            <div>
                                                                ...
                                                                <select
                                                                    wire:model="dados.esquerdo.localizacao_lesao_id"
                                                        ...
                                                        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2">
                                                            <div>
                                                                ...
                                                                <select
                                                                    wire:model="dados.esquerdo.quantidade_exudato_id"
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            <div class="mb-8">
                                                <h2 class="mb-2 text-2xl font-bold text-indigo-900">Cuidados com a
                                                    Ferida
                                                </h2>
                                                <div
                                                    class="w-24 h-1 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-700">
                                            ...
                                            <div class="grid grid-cols-1 gap-8 mb-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-6 border border-gray-100 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <select wire:model="avaliacao_ferida_id"
                                                        id="avaliacao_ferida_id"
                                                        class="w-full px-4 py-3 text-gray-700 bg-white border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none">
                                                        <option value="">Selecione</option>
                                            ...
                                            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-6 border border-gray-100 bg-gray-50 rounded-2xl">
                                                    ...
                                                    <div class="flex gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio"
                                                                wire:model="aplicacao_laserterapia" value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio"
                                                                wire:model="aplicacao_laserterapia" value="0"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Não</span>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="mb-10">
                                            <div class="mb-8">
                                                <h2 class="mb-2 text-2xl font-bold text-indigo-900">Avaliação do Pé
                                                </h2>
                                                <div
                                                    class="w-24 h-1 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-700">
                                                </div>
                                            ...
                                            <div class="p-6 border border-gray-100 bg-gray-50 rounded-2xl">
                                                ...
                                                @elseif ($imagem_avaliacao_pe_url)
                                                    <div class="mt-6">
                                                        <p class="mb-3 text-sm font-medium text-gray-700">Imagem
                                                            atual:
                                                        </p>
                                                        <div class="p-4 bg-white border border-gray-200 rounded-xl">
                                    ...
                                    <div class="p-8 border shadow-lg bg-white/90 rounded-3xl border-white/20">
                                        ...
                                        <div class="pb-8 mb-10 border-b border-gray-200">
                                            ...
                                            <div class="space-y-8">
                                                ...
                                                <div class="p-6 border border-pink-100 bg-pink-50 rounded-2xl">
                                                    <label
                                                        class="block mb-6 text-lg font-semibold text-gray-800">Estado
                                                        Emocional</label>
                                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                                                ...
                                                <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                                    ...
                                                    <div class="p-6 border border-pink-100 bg-pink-50 rounded-2xl">
                                                        ...
                                                        <input type="text" wire:model="auxiliador"
                                                            id="auxiliador"
                                        ...
                                        <div class="mb-12">
                                            <div class="mb-8">
                                                <h2 class="mb-2 text-2xl font-bold text-indigo-900">Comunicação e
                                                    Gregária
                                                </h2>
                                                <div
                                            ...
                                            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                                ...
                                                <div class="p-6 border border-indigo-100 bg-indigo-50 rounded-2xl">
                                                    ...
                                                    <div class="flex gap-6">
                                                        <label class="flex items-center cursor-pointer">
                                                            <input type="radio" wire:model="apoio"
                                                                value="1"
                                                                class="w-5 h-5 text-indigo-600 border-2 border-gray-300 focus:ring-indigo-500">
                                                            <span class="ml-3 font-medium text-gray-700">Sim</span>
                                                        </label>
