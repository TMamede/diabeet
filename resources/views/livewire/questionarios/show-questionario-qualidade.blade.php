                    ...
                    <div class="p-8 space-y-8">
                        ...
                        @if (!is_null($exercicio))
                            <div>
                                ...
                                <span
                                    class="inline-flex items-center px-3 py-1 text-sm font-semibold text-orange-800 bg-orange-100 rounded-full">
                        ...
                        @if (!is_null($comer))
                            <div
                                class="{{ !is_null($exercicio) || !is_null($incomodo) ? 'pt-6 border-t border-gray-200' : '' }}">
                                <label class="block mb-2 text-lg font-semibold text-gray-800">
                                    Com que frequência você come algo que não deveria ao invés de dizer que tem
                                    diabetes?
                                </label>
                                <span
                                    class="inline-flex items-center px-3 py-1 text-sm font-semibold text-orange-800 bg-orange-100 rounded-full">
            ...
            @if (!is_null($ter_filhos))
                <div class="overflow-hidden border shadow-xl bg-white/80 backdrop-blur-sm rounded-2xl border-white/20">
                    ...
                    <div class="p-8">
                        ...
                        <span
                            class="inline-flex items-center px-3 py-1 text-sm font-semibold text-purple-800 bg-purple-100 rounded-full">
