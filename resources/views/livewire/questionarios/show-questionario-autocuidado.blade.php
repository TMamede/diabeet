        ...
        <div class="max-w-4xl mx-auto space-y-8">
                ...
                <div class="p-8 space-y-6">
                    @if(!is_null($frutas))
                        <div>
                            ...
                            <span class="inline-flex px-3 py-1 text-sm font-semibold text-orange-800 bg-orange-100 rounded-full">
                    ...
                    @endif
                    @if(!is_null($doces))
                        <div class="{{ (!is_null($frutas) || !is_null($gorduras)) ? 'pt-4 border-t border-gray-100' : '' }}">
                            <p class="mb-2 text-lg font-semibold text-gray-800">
                                Doces:
                            </p>
                            <span class="inline-flex px-3 py-1 text-sm font-semibold text-orange-800 bg-orange-100 rounded-full">
                ...
                <div class="p-8 space-y-6">
                    @if(!is_null($avaliou))
                        <div>
                            ...
                            <span class="inline-flex px-3 py-1 text-sm font-semibold rounded-full bg-cyan-100 text-cyan-800">
            ...
            <div class="overflow-hidden border shadow-xl bg-white/80 backdrop-blur-sm rounded-2xl border-white/20">
                ...
                <div class="p-8 space-y-6">
                    ...
                    @endif
                    @if(!is_null($dedos))
                        <div class="{{ (!is_null($pes) || !is_null($sapatos)) ? 'pt-4 border-t border-gray-100' : '' }}">
