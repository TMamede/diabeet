    ...
    <form>
                ...
                <div class="w-full py-12 bg-gray-100">
                        ...
                        <div class="mt-4 bg-white rounded-lg shadow-lg">
                            ...
                            <div class="py-3 border-b border-gray-200 cursor-pointer hover:bg-gray-100"
                                ...
                                <div class="flex flex-col px-6">
                                    <span class="text-lg font-medium text-gray-900">{{ $paciente->nome }}</span>
                    ...
                    <div class="max-w-4xl p-8 mx-auto mt-10 bg-white rounded-lg shadow-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            ['label' => 'Orientação Sexual', 'value' =>
                            $selectedPaciente->orientacao_sexual->descricao],
                            ...
                            ['label' => 'Número de pessoas morando em casa', 'value' =>
                            $selectedPaciente->num_pss_casa],
                            ] as $item)
                    ...
                    <div class="max-w-4xl p-8 mx-auto mt-10 bg-white rounded-lg shadow-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            @foreach ([['label' => 'Tipo de Diabetes', 'value' =>
                            $selectedPaciente->historico->tipo_diabetes->tipo], ['label' => 'Motivo de Cirurgia',
                            'value' => $selectedPaciente->historico->cirurgia_motivo], ['label' => 'Onde a Amputação',
                            'value' => $selectedPaciente->historico->amputacao_onde], ['label' => 'Data da Amputação',
                            'value' => $selectedPaciente->historico->amputacao_quando], ['label' => 'Número de Cigarros
                            Diários', 'value' => $selectedPaciente->historico->n_cigarros], ['label' => 'Início do
                            Tabagismo', 'value' => $selectedPaciente->historico->inicio_tabagismo], ['label' => 'Início
                            do Etilismo', 'value' => $selectedPaciente->historico->inicio_etilismo]] as $item)
                            <div class="flex flex-col">
                                <label class="text-sm font-medium text-gray-600">{{ $item['label'] }}</label>
                                <div class="p-3 mt-1 text-gray-800 bg-gray-300 rounded-md shadow-inner">
                                    {{ $item['value'] }}
                    ...
                    <div class="max-w-4xl p-8 mx-auto mt-10 bg-white rounded-lg shadow-lg">
                        ...
                        <div class="space-y-4">
                            ...
                            <div
                                class="p-6 transition duration-150 ease-in-out bg-gray-300 border border-gray-300 rounded-lg shadow-md">
                                <h4 class="mb-2 text-xl font-semibold text-gray-900">Resultado #{{ $loop->iteration }}
                                </h4>
        ...
        <div x-show="step === 2" x-transition>
            ...
            <div class="step">
                ...
                <div class="pb-5 border-b border-gray-300">
                    ...
                    <div class="flex mb-4 space-x-4">
                        ...
                        <div class="w-1/3">
                            ...
                            <select wire:model="comportamento_regulacao_neuro_id" id="comportamento_regulacao_neuro_id"
                                ...
                                <option value="{{ $comportamento->id }}">{{ $comportamento->descricao }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="w-1/2">
                            <div class="mb-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" wire:model="problema_sonos" value="{{ $problema->id }}"
                ...
                <div class="pb-5 border-b border-gray-300">
                    ...
                    <div class="flex items-center mb-4 space-x-4">
                        ...
                        <div class="w-1/3">
                            <label for="glicemia_capilar" class="block font-medium text-gray-700">Glicemia capilar do
                                momento</label>
            ...
            <div class="pb-5 border-b border-gray-300">
                ...
                <div class="flex items-center mt-4">
                    ...
                    <span class="ml-2 text-green-600"><strong>{{ $classificacaoTemperatura }}</strong></span>
                </div>
                @endif
            </div>
            ...
            <div class="pb-5 border-b border-gray-300">
                ...
                <div class="flex mb-4 space-x-4">
                    ...
                    <div class="w-1/3">
                        <label for="incontinencia_urina" class="block mb-2 font-medium text-gray-700">Incontinência -
                            urina:</label>
                        <div class="flex items-center mt-1 space-x-6">
                            <label class="inline-flex items-center">
                ...
                <div class="flex mb-4 space-x-4">
                    ...
                    <div class="w-1/3">
                        <label for="dor_eliminacoes" class="block mb-2 font-medium text-gray-700">Dor - eliminação
                    ...
                    <div class="w-1/3">
                        <label for="incontinencia_eliminacao" class="block mb-2 font-medium text-gray-700">Incontinência
                            - eliminação
                            gastrointestinal:</label>
                        <div class="flex items-center mt-1 space-x-6">
                            <label class="inline-flex items-center">
                ...
                <div class="flex mb-4 space-x-4">
                    ...
                    <div class="w-1/3">
                        <label for="constipacao" class="block mb-2 font-medium text-gray-700">Constipação:</label>
                        <div class="flex items-center mt-1 space-x-6">
                            <label class="inline-flex items-center">
        ...
        <div class="pb-5 border-b border-gray-300">
            ...
            <div class="relative w-full h-48">
                ...
                <img src="{{ asset('trace.svg') }}" alt="Trace" class="absolute inset-0 object-contain w-full h-full">
            </div>
            ...
            <div>
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" wire:model="sinais_infeccaos" value="{{ $sinais->id }}"
                                id="sinais-{{ $sinais->id }}"
                                class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                ...
                <div class="flex items-center mb-4 space-x-10">
                    ...
                    <div>
                        <label for="larguraD" class="block font-medium text-gray-700">Largura
                            (cm):</label>
                        <input type="number" wire:model="larguraD" id="larguraD" placeholder="Digite a largura"
                            class="block w-full mt-1 border border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                    </div>
                </div>
                <div class="flex mb-4 space-x-4">
                    <!-- Zona de Moradia -->
                    <div class="w-1/4">
                        <label for="localizacao_lesao_direito_id" class="block font-medium text-gray-700">Localização
                            Anatômica da
                            lesão:</label>
                    ...
                    <!-- Rede de Esgoto -->
                    <div class="w-1/4">
                        <label for="regiao_pe_direito_id" class="block font-medium text-gray-700">Região:</label>
                ...
                <div class="flex items-center mb-4 space-x-10">
                    ...
                    <div>
                        <label for="larguraE" class="block font-medium text-gray-700">Largura
                            (cm):</label>
                        <input type="number" wire:model="larguraE" id="larguraE" placeholder="Digite a largura"
                            class="block w-full mt-1 border border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                    </div>
                </div>
                <div class="flex mb-4 space-x-4">
                    <!-- Zona de Moradia -->
                    <div class="w-1/4">
                        <label for="localizacao_lesao_esquerdo_id" class="block font-medium text-gray-700">Localização
                            Anatômica da
                            lesão:</label>
                    ...
                    <!-- Rede de Esgoto -->
                    <div class="w-1/4">
                        <label for="regiao_pe_esquerdo_id" class="block font-medium text-gray-700">Região:</label>
            ...
            <div class="flex mb-6 space-x-4">
                ...
                <div class="w-1/4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" wire:model="limpeza_lesaos" value="{{ $limpeza->id }}"
        ...
        <div>
            <label for="imagem_avaliacao_pe" class="block mt-4 text-lg font-medium text-gray-700">Avaliação do
                Pé (Imagem)</label>
            ...
            <div class="mt-6">
                ...
                <div class="w-full max-w-4xl p-6 mx-auto border border-indigo-100 rounded-lg shadow-lg bg-gray-50">
                    <img src="{{ $imagem_avaliacao_pe->temporaryUrl() }}" alt="Pré-visualização da imagem"
...
<div x-show="step === 4" x-transition>
    ...
    <div class="step">
        ...
        <div class="pb-5 mb-6 border-b border-gray-300">
