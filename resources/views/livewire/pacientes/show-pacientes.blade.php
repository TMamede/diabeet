<div class="w-fullflex flex-row min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
    <div x-data="{ step: @entangle('currentStep'), open: false }">
        <div class="px-6 py-4">
            <div class="block lg:hidden mb-1 px-6 py-8 border shadow-lg bg-white/80 rounded-3xl border-white/20">
                ...
                <select wire:change="changeStep($event.target.value)"
                    ...
                    <option value="2">Histórico do Paciente</option>
                    <option value="3">Medicamentos</option>
                    <option value="4">Resultados</option>
                    <option value="5">Unidade de Saúde</option>
                    <option value="6">Avaliações de Enfermagem</option>
                </select>
                                ...
                                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select wire:model="orientacao_sexual_id" id="orientacao_sexual_id"
                                            ...
                                            @foreach ($orientacoesSexuais as $orientacao)
                                                <option value="{{ $orientacao->id }}">{{ $orientacao->descricao }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label for="renda_familiar"
                                            class="block mb-2 text-sm font-semibold text-gray-700">Renda
                                            Familiar</label>
                                        <div class="relative">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select wire:model="beneficio_id" id="beneficio_id"
                                            ...
                                            @foreach ($beneficios as $beneficio)
                                                <option value="{{ $beneficio->id }}">{{ $beneficio->descricao }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('beneficio_id')
                                    ...
                                    <div class="form-group">
                                        <label for="reside_id"
                                            class="block mb-2 text-sm font-semibold text-gray-700">Com
                                            quem reside</label>
                                    ...
                                    <div class="form-group">
                                        <label for="num_pss_casa"
                                            class="block mb-2 text-sm font-semibold text-gray-700">Pessoas em
                                            casa</label>
                        ...
                        <div class="step">
                            <div
                                ...
                                <main class="relative z-10 flex-1 px-6 py-8 lg:px-8">
                                    ...
                                    <div class="p-8 mb-8 border shadow-lg bg-white/80 rounded-3xl border-white/20">
                                        <!-- Section Title -->
                                        <div class="pb-4 mb-8 border-b border-purple-100">
                                            <h2 class="flex items-center gap-3 text-2xl font-bold text-indigo-900">
                                                <div
                                                    ...
                                                    <svg class="w-4 h-4 text-purple-700" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                            ...
                                            <p class="mt-2 text-indigo-600">Informações sobre diabetes, cirurgias e
                                                hábitos
                                                do
                                                paciente</p>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="relative">
                                                    <input type="text" wire:model="cirurgia_motivo"
                                                        id="cirurgia_motivo"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" wire:model="amputacao_quando"
                                                    id="amputacao_quando"
                                                    class="w-full px-4 py-3 border border-gray-200 bg-white/70 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-200 focus:bg-white">
                                        ...
                                        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                                            ...
                                            <div class="lg:col-span-2">
                                                <div class="pb-4 mb-6 border-b border-purple-100">
                                                    <h3
                                                        class="flex items-center gap-3 text-xl font-bold text-indigo-900">
                                                        <div
                                                ...
                                                <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                                                    @foreach ($comorbidadesList as $comorbidade)
                                                        <div class="relative group">
                                                            <input type="checkbox"
                                                                id="comorbidade_{{ $comorbidade->id }}"
                                                                wire:model="comorbidades"
                                                                value="{{ $comorbidade->id }}" class="sr-only peer"
                                    ...
                                    <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <div
                                                ...
                                                <svg class="w-6 h-6 text-pink-700" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                                                ...
                                                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="medicamentos.{{ $index }}.via_id"
                                                            class="block mb-2 text-sm font-semibold text-gray-700">Via
                                                            de
                                                            Administração</label>
                                                        <div class="relative">
                                                            <select
                                                                wire:model="medicamentos.{{ $index }}.via_id"
                                        ...
                                        @if (empty($medicamentos))
                                            <div
                                                ...
                                                <h3 class="mb-2 text-lg font-semibold text-gray-600">Nenhum medicamento
                                                    cadastrado</h3>
                                                <p class="mb-6 text-gray-500">Clique no botão "Adicionar Medicamento"
                                                    para
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h1 class="text-2xl font-bold text-indigo-900 lg:text-4xl">
                                                        {{ $nome }}</h1>
                                                    <p class="font-medium text-indigo-600">Resultados Médicos Prévios
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="p-8 border shadow-lg bg-white/80 rounded-3xl border-white/20">
                                        ...
                                        <div class="pb-4 mb-8 border-b border-indigo-100">
                                            <div class="flex flex-col lg:flex-row items-center justify-between">
                                                <div>
                                                    <h2
                                                        class="flex items-center gap-3 text-2xl font-bold text-indigo-900">
                                                        <div
                                        ...
                                        <div class="space-y-6">
                                                        ...
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <h3 class="text-xl font-bold text-gray-800">Resultado
                                                                    {{ $index + 1 }}</h3>
                                                                <p class="text-sm text-gray-500">Exame médico
                                                                    registrado
                                                                </p>
                                                            </div>
                                                        </div>
                                            ...
                                            @if (empty($resultados))
                                                <div
                                                    ...
                                                    <h3 class="mb-2 text-lg font-semibold text-gray-600">Nenhum
                                                        resultado
                                                        cadastrado</h3>
                                                    <p class="mb-6 text-gray-500">Registre os resultados de exames
                                                        médicos
                                ...
                                <main class="relative z-10 flex-1 px-6 py-8 lg:px-8">
                                    ...
                                    <div class="p-8 border shadow-lg bg-white/80 rounded-3xl border-white/20">
                                        ...
                                        <div class="pb-4 mb-8 border-b border-indigo-100">
                                            ...
                                            <p class="mt-2 text-indigo-600">Selecione a unidade de saúde responsável
                                                pelo
                                        ...
                                        <div class="max-w-4xl">
                                            ...
                                            <div class="form-group">
                                                                ...
                                                                <div class="flex items-center gap-3">
                                                                    ...
                                                                    <div>
                                                                        <h3
                                                                            ...
                                                                            {{ $unidadeSelecionada->ubs }}
                                                                        </h3>
                                                                        <p class="mt-1 text-sm text-green-600">
                                                                            {{ $unidadeSelecionada->telefone }}<br>
                                                                            {{ $unidadeSelecionada->endereco->rua }}
                                                                            {{ $unidadeSelecionada->endereco->numero }}<br>
                                                                            {{ $unidadeSelecionada->endereco->bairro }}<br>
                                                                            {{ $unidadeSelecionada->endereco->cidade }}
                                                                            - {{ $unidadeSelecionada->endereco->uf }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <!-- Dropdown de Seleção -->
                                                <div x-show="!@js($unidade_saude_id) || showDropdown"
                                                    x-transition>
                                                    <div class="space-y-3">
