                                ...
                                <tbody>
                                    ...
                                    <tr wire:key="{{ $paciente->id }}" class="border-b">
                                        ...
                                        <td class="flex items-center justify-end px-4 py-3 mr-5">
                                            <button wire:click="nextStepAndSelectPaciente('{{ $paciente->id }}')"
                                    ...
                                    <x-new-modal name="confirm-paciente-deletion-{{ $paciente->id }}"
                                        ...
                                        <form wire:submit.prevent="deletePaciente" class="p-2">
                                            ...
                                            <h2 class="text-sm font-medium text-gray-900">{{ __('Se excluí-lo os questionários e prontuários associados a ele também serão excluidos.')}}</h2>
                                            ...
                                            <div class="flex justify-end mt-6">
                                                ...
                                                <x-danger-button wire:click="deletePaciente" x-on:click="$dispatch('close')" class="ms-3">{{ __('Excluir Paciente') }}
                                                </x-danger-button>
                                            </div>
                                        </form>
                                    </x-new-modal>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li>
                            <button wire:click="nextStepFifth"
                                class="flex items-center justify-start w-full py-3 pl-1 pr-4 text-gray-800 transition duration-150 ease-in-out rounded-lg hover:bg-indigo-50 hover:text-indigo-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-3 text-indigo-500" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div class="flex items-center p-4 transition duration-200 bg-white border border-gray-300 rounded-lg cursor-pointer hover:bg-blue-50"
                                        ...
                                        <input type="checkbox" id="comorbidade_{{ $comorbidade->id }}"
                                            ...
                                            class="mr-2 text-blue-600 focus:ring-blue-500" {{ in_array($comorbidade->id,
                                        $comorbidades) ? 'checked' : '' }}>
                                        <label for="comorbidade_{{ $comorbidade->id }}" class="text-sm text-gray-700">{{
                                            $comorbidade->descricao }}</label>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="w-1/2">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div class="flex items-center p-4 transition duration-200 bg-white border border-gray-300 rounded-lg cursor-pointer hover:bg-blue-50"
                                        ...
                                        <input type="checkbox" id="alergia_{{ $alergia->id }}" wire:model="alergias"
                                            value="{{ $alergia->id }}" class="mr-2 text-blue-600 focus:ring-blue-500" {{
                                            in_array($alergia->id, $alergias) ? 'checked' : '' }}>
                                        <label for="alergia_{{ $alergia->id }}" class="text-sm text-gray-700">{{
                                            $alergia->descricao }}</label>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                ...
                <main class="flex-1 p-6 bg-stone-50">
                    ...
                    <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        ...
                        <div class="mb-6">
                            ...
                            <select wire:model="medicamentos.{{ $index }}.via_id" id="medicamentos.{{ $index }}.via_id"
            ...
            <div class="flex">
                ...
                <main class="flex-1 p-6 bg-stone-50">
                    ...
                    <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        ...
                        <button type="button" wire:click="removeResultado({{ $index }}, {{ $IdPaciente }})"
                            class="px-4 py-2 font-semibold text-white rounded-lg shadow-sm bg-rose-700 hover:bg-rose-800 focus:outline-none focus:ring-2 focus:ring-rose-600 focus:ring-offset-2">
                            Remover
                        </button>
                    </div>
