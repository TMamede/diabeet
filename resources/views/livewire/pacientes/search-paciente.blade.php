                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach ($pacientes as $paciente)
                                <tr wire:key="{{ $paciente->id }}"
                                    ...
                                    <td class="px-4 py-4 text-gray-900 text-sm font-medium">
                                        {{ \Carbon\Carbon::parse($paciente->data_nasc)->format('d/m/Y') }}
                                    </td>
                                    <td class="px-4 py-4">
                                        <div class="flex items-center">
                                            <div
                                                class="w-7 h-7 bg-green-600 rounded-full flex items-center justify-center text-white font-medium text-xs mr-2">
                                                {{ substr($paciente->user->name, 0, 1) }}
                                            </div>
                                            <span
                                                class="text-indigo-600 text-sm font-medium">{{ $paciente->user->name }}</span>
                                        </div>
                                    </td>
                                        ...
                                        <div class="text-center mb-6">
                                            ...
                                            <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                                                <p class="text-sm text-red-800 font-medium">⚠️ Atenção: Esta ação é
                                                    irreversível!</p>
                                                <p class="text-sm text-red-700 mt-1">Os questionários e prontuários
