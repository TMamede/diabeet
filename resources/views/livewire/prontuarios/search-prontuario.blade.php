                                ...
                                <x-new-modal name="confirm-questionario-deletion-{{ $questionario->id }}"
                                    ...
                                    <div class="p-8">
                                        <div class="mb-6 text-center">
                                            ...
                                            <p class="mb-4 text-gray-600">Você tem certeza de que deseja excluir esta avaliação de enfermagem?</p>
                                            <div class="p-4 mb-6 border border-red-200 rounded-lg bg-red-50">
                                                ...
                                                <p class="mt-1 text-sm text-red-700">As prescrições associadas a esta avaliação de enfermagem também serão excluídas.</p>
                                            </div>
                                        </div>
