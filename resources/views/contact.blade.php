                    ...
                    <div class="p-8 text-gray-900">
                        <div class="container mx-auto">
                            ...
                            <form wire:submit.prevent="submit" class="space-y-6">
                                ...
                                <!-- Mensagem -->
                                <div class="mb-4">
                                    <label for="message" class="block text-base font-medium text-gray-700">Mensagem</label>
                                ...
                                <div class="flex justify-center mt-4 space-x-4">
                                    <div class="flex items-center">
                                        <svg class="w-6 h-6 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M14.5 3h-9C4.67 3 4 3.67 4 4.5v11c0 .83.67 1.5 1.5 1.5h9c.83 0 1.5-.67 1.5-1.5v-11C16 3.67 15.33 3 14.5 3zM10 14.25a1.75 1.75 0 1 1 0-3.5 1.75 1.75 0 0 1 0 3.5z"/>
                                        </svg>
