...
<body class="font-sans antialiased">
    <div class="min-h-dvh bg-indigo-50">
    ...
    <footer class="relative z-10 py-6 text-white bg-indigo-800">
        <div class="container px-6 mx-auto">
            <div class="flex flex-col items-center justify-between md:flex-row">
                <div class="mb-4 md:mb-0">
                    <h4 class="text-xl font-bold">SIPEDIA</h4>
                    <p class="mb-5 text-sm text-indigo-200">Sistema Integrado ao Processo de Enfermagem para Pessoas com a Doença do Pé Relacionada ao Diabetes
                    </p>
