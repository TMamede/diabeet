                    ...
                    <div class="container px-6 mx-auto text-center">
                        ...
                        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div class="p-6 bg-white rounded-lg shadow-lg">
                                <div class="mb-4">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        ...
                                        class="w-16 h-16 mx-auto text-indigo-700">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
                                    </svg>

                                </div>
                                <h4 class="mb-4 text-xl font-semibold text-indigo-700">Avaliações de Enfermagem</h4>
                                <p class="text-gray-700">
                                    Avaliações detalhadas com questionários específicos para o tratamento do pé
                                    diabético.
                                </p>
                            </div>
                            ...
                            <div class="p-6 bg-white rounded-lg shadow-lg">
                                ...
                                <h4 class="mb-4 text-xl font-semibold text-indigo-700">Prescrições</h4>
                                <p class="text-gray-700">
