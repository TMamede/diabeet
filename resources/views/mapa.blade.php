            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="mb-10 text-center">
                    ...
                    <p class="max-w-2xl mx-auto text-lg text-gray-600 md:text-xl">
                        Navegue facilmente por todas as funcionalidades do SIPEDIA e encontre rapidamente o que você
                        precisa
                    </p>
                </div>
                    ...
                    <div class="p-6 md:p-10 lg:p-12">
                        <div class="mb-10 text-center">
                            ...
                            <p class="max-w-3xl mx-auto text-base leading-relaxed text-gray-600 md:text-lg">
                                Acesse rapidamente todas as áreas do sistema de prescrição eletrônica para pessoa com a doença do pé relacionada ao diabetes.
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div class="group">
                                <div
                                    class="h-full p-6 transition-colors border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-indigo-50/50">
                                    <div class="flex items-center mb-4">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 mr-3 bg-indigo-600 rounded-lg">
                            ...
                            <div class="group">
                                <div
                                    class="h-full p-6 transition-colors border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-emerald-50/50">
                                    <div class="flex items-center mb-4">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-emerald-600">
                                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="group">
                                <div
                                    class="h-full p-6 transition-colors border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-cyan-50/50">
                                    <div class="flex items-center mb-4">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-cyan-600">
                                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <h4 class="text-lg font-bold text-gray-800 md:text-xl">Avaliação de Enfermagem
                                        </h4>
                                    </div>
                                    <ul class="space-y-2.5 text-gray-700">
                                        <li>
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2">
                            ...
                            <div class="group">
                                <div
                                    class="h-full p-6 transition-colors border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-amber-50/50">
                                    <div class="flex items-center mb-4">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 mr-3 bg-orange-600 rounded-lg">
                                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            ...
                            <div class="group">
                                <div
                                    class="h-full p-6 transition-colors border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-pink-50/50">
                                    <div class="flex items-center mb-4">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 mr-3 bg-purple-600 rounded-lg">
                                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="mt-10 text-center">
                            <div
                                class="p-6 border border-indigo-100 md:p-8 rounded-2xl bg-gradient-to-r from-white to-purple-50/40">
