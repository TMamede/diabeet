            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="mb-12 text-center">
                    ...
                    <p class="max-w-3xl mx-auto text-xl leading-relaxed text-gray-600">
                        ...
                        pacientes com a doença do pé relacionada ao diabetes.
                    </p>
                </div>

                <!-- Card -->
                <div class="p-10 border shadow-lg bg-white/95  border-white/20 rounded-3xl hover:shadow-xl space-y-8">

                    <div>
                        <p class="text-gray-600 mb-4">
                            <strong>Data de Vigência:</strong> 21 de fevereiro de 2026
                        </p>
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-800 mb-3">5. Uso Adequado da Plataforma</h2>
                        <p class="text-gray-700 leading-relaxed">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-800 mb-3">6. Propriedade Intelectual</h2>
                        <p class="text-gray-700 leading-relaxed">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-800 mb-3">7. Isenção de Garantias</h2>
                        <p class="text-gray-700 leading-relaxed">
                            O aplicativo é fornecido "como está", sem garantias de funcionamento contínuo,
                            ausência de falhas ou adequação a finalidades específicas.
                        </p>
                    </div>
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-800 mb-3">9. Lei Aplicável</h2>
                        <p class="text-gray-700 leading-relaxed">
                            Estes Termos são regidos pelas leis da República Federativa do Brasil,
                            sendo competente o foro brasileiro para dirimir eventuais controvérsias.
                        </p>
                    </div>

                    <div>
                        <h2 class="text-xl font-bold text-gray-800 mb-3">10. Alterações</h2>
                        <p class="text-gray-700 leading-relaxed">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-800 mb-3">11. Contato</h2>
                        <p class="text-gray-700 leading-relaxed">
